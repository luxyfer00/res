...
const node =
  "https://ethereum.blockpi.network/v1/rpc/public"; // for a list of all chains nodes refer to this website , find your chain and select the fastest node : https://chainlist.org/
...
async function main() {
  ...
  let CustomGas = "5"; // custom standard gas
